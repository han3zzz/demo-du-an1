...
public class MauSacForm extends javax.swing.JFrame {
     ...
     */
    private IMauSacServices services;

    public MauSacForm() {
        initComponents();

        services = new MauSacServices();
        load();
    }
    ...
    private void btnUpdateMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnUpdateMousePressed
        ...
        try {
            ...
            MauSac n = layTTSua();
            if (n.getMaMauSac().trim().isEmpty() || n.getTenMauSac().trim().isEmpty()) {
            ...
            Logger.getLogger(MauSacForm.class.getName()).log(Level.SEVERE, null, ex);
        }
